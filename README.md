...
Enterprise AI strategist focused on workflow economics, control-plane architecture, revenue intelligence, and technology-led value creation.

I use GitHub to publish public strategy artifacts, reference architectures, and financial models that translate AI capability into operating-model and capital-allocation decisions.

## Current public artifacts

### [Enterprise AI Control Plane](https://grikard.github.io/enterprise-ai-control-plane/)
Reference architecture for governed orchestration across applications, agents, models, tools, telemetry, and revenue workloads.
